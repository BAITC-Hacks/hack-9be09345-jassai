...
const items=[
  ...
  ['body_starter','Изумрудный чапан','body','Чапан с золотым орнаментом для нового пути.','starter',0,'Доступно с самого начала','#087B5A','shirt'],
  ...
  ['body_explorer','Синий чапан исследователя','body','Новый цвет чапана за три разных опыта на вашем пути.','distinct_events',3,'Завершить 3 разные активности с наградами','#5A72B5','shirt'],
